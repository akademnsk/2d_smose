...
Three of the found structures, called 1A'-SMoSe and SVSe-1M are especially perspective for experimental synthesis and practical application.
...
To evaluate the probability for the synthesis of 1A and 1A' structures on the substrate of the other compounds, we have performed the search through the ICSD for the structures with similar kagome lattices of vanadium or molybdenum.
