...
\begin{figure}[H]
	...
	\caption{Phonon dispersion curves of SVSe structures.\textcolor{red}{Нурсултан, расположи, пожалуйста? и здесь и в табличке с энтальпиями структуры в том порядке, в каком они сейчас в таблице со структурными данными. В тексте я тоже их в такой последовательности излагаю} }
	\label{phon_svse}
\end{figure}
