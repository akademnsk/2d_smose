...
T-hor structures similarly to 1H is charactersied by the octahedral coordination of TM atoms.
The difference is that, in T-hor structure not only edge-sharing but also face shring of cooridnation octahedra are realised (Figure \ref{H_hor}).
In T-hor structure each octahedra have four common edges and one common face.
...
%In optimised 1H structure, the Mo--Mo bonds distances are equal to 3.25 \AA, in H-hor it reaches 3.08 \AA, 
%The dimers are in turn connected in chains and layers by the weaker bonds.

\begin{figure}[H]
        \includegraphics[width=0.5\textwidth]{T_hor_1.jpg} \\
        \includegraphics[width=0.5\textwidth]{T_hor_2.jpg}
