...
The search of the structural analogues of the new structures of the dichalcogenides have not only fundamental importance but also of a practical application.
Similar structures can be useed as the seeds (подложки) for the synthesis of the new structures, which are energetically less favourable than H and T structures.
