...
\begin{table}[H]
	\caption{Calculated enthalpies of SMoSe and SVSe structures obtained within crystal structure prediction techniques.} \label{t:enthalpy} \vspace{2mm}
	\centering
	\begin{tabular}{l*{5}{l}}
		\hline \hline
		\multirow{2}*{Phase} & \multicolumn{2}{c}{Enthalpy (eV/f.u.)} & \multicolumn{2}{c}{Relative  to the most favourable (eV/f.u.)}	\\
		\cline{2-3} \cline{4-5}
